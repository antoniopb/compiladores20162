 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.ufcg.compiladores.pascal.impl.case_statementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.xtext.ufcg.compiladores.pascal.impl.case_statementImpl#getCase_limbs <em>Case limbs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class case_statementImpl extends MinimalEObjectImpl.Container implements case_statement
{
  ...
  public EList<case_limb> getCase_limbs()
  {
    if (case_limbs == null)
    {
      case_limbs = new EObjectContainmentEList<case_limb>(case_limb.class, this, PascalPackage.CASE_STATEMENT__CASE_LIMBS);
    }
    return case_limbs;
  }
